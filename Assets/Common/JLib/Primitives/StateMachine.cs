...
namespace JLib.Utilities
{
    ...
    public class StateMachine
    {
        ...
        // ----------------------------------------------------------------------------
        {
//            Dbg.Assert(state.GetStateId() == -1);
            Dbg.Assert(_states.Contains(state) == false);
        ...
        // ----------------------------------------------------------------------------
        {
            ...
            {
                Dbg.LogWarning(_debugName + " Received queue state while already in state transition");
            }
        ...
        // ----------------------------------------------------------------------------------------------
        {
            ...
            if (CurrentState != null)   // do the exit
            {
                ...
                {
                    Dbg.LogWarning("Transition from " + CurrentState + " to " + newState + " is invalid ");
                }
