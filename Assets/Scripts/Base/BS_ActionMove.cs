...
namespace Pit
{
    public class BS_ActionMove : BS_Action
    {
        ...
        public override void SetTarget(Vector3 targetPt)
        {
            base.SetTarget(targetPt);
            _totalDistanceCovered = 0.0f;
        ...
        bool IsMovingToDestination(MT_Combatant c, Vector3 destination)
        {
            ...
            if ((c.Pawn.transform.position - TargetPoint).sqrMagnitude < 0.2f)
                return false;
