...
namespace Pit
{
    ...
    public class MT_InputModeSelectPath : MT_InputMode
    {
        ...
        // -------------------------------------------------------------------------
        {
            ...
            _lineId = Game.Match.Widgets.HidePath(_lineId);
            _done = false;
            base.OnDisable();
        }
        ...
        // -------------------------------------------------------------------------
        {
            ...
            if (Game.Match.Arena.FindTerrainPointUnderMouse(Game.Match.MainCamera, ref newPt))
            {
        ...
        void SetLine( UnityEngine.AI.NavMeshPath path)
        {
            ...
            _lineId = Game.Match.Widgets.ShowPath(_pointList, _lineId);
        }
    }
}
