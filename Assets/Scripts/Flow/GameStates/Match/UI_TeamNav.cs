...
namespace Pit.Flow
{
    public class UI_TeamNav : MonoBehaviour
    {
        //[SerializeField]
        ...
        public void OnZoom()
        {
  //### PSJ TODO fix v2          Events.SendGlobal(new MT_SetCameraToLookAtEvent() { Target = Game.UI.Match.SelectedPCCombatant.Pawn.transform.position });
        }
        ...
        {
            // TODO fix team navigation on change team
