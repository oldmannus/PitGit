...
namespace Pit
{
    ...
    public abstract class MT_ActionInstance
    {
        ...
        public BS_Combatant Owner;    // object Id of who is taking the action
        ...
        public MT_ActionInstance(BS_ActionDesc temp, BS_Combatant owner, int actionPoints = -1)
        {
            ActionTemplate = temp;
            Owner = owner;
            if (actionPoints < 0)
    ...
    {
        public BS_Combatant TargetCombatant;

        public MT_TargetCombatantActionInstance(BS_ActionDesc temp, BS_Combatant owner, BS_Combatant target) : base(temp, owner)
        {
    ...
    //    public MT_MeleeAttackActionInstance(BS_ActionAttack actionTemplate, BS_Combatant owner, BS_Combatant target)
    ...
    //    public MT_MoveActionResult(FVec3 startPt, FVec3 endPt, int apConsumed, BS_MoveAction actionTemplate, BS_Combatant owner)
