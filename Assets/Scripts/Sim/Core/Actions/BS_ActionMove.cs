...
//            Icon = Game.Data.Icons.GetIcon("Feet");
//        }
...
//                Game.Match.InputMgr.QueueInputMode<MT_InputModeSelectPath>(c);
...
//                Game.Match.InputMgr.QueueInputMode<MT_InputModeNone>();

//                MT_SelectedPathEvent ev = ews.GetEvent() as MT_SelectedPathEvent;
//                if (ev == null)
//                {
//                    Game.Match.InputMgr.QueueInputMode<MT_InputModeBase>();
//                    yield break;
//                }

//                markerId = Game.Match.Widgets.ShowDestinationPoint(ev.Where, -1);
...
//            Game.Match.Widgets.HideDestinationPoint(markerId);
//            Game.Match.InputMgr.QueueInputMode<MT_InputModeBase>();
//            yield return null; 
//        }
