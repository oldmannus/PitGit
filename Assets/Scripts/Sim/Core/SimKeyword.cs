...
namespace Pit
{
    ...
    public class BS_KeywordSet : Pit.Utilities.FlagSet
    {
        public void Add(SimKeyword keyword)
        {
        ...
        public void Remove(SimKeyword keyword)
        {
            base.Remove((int)keyword);
        }
        public bool HasFlag(SimKeyword key)
        {
