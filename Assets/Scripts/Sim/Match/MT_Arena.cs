...
namespace Pit.Sim
{
    ...
    public class MT_Arena : SM_Space
    {
        ...
        /// Set in editor
        /// </summary>
//###PJS TODO removed v2        public UI_WidgetMgr Widgets = null;


        public GameObject           PawnRoot; // set in editor
        public ArenaDescriptor   Description { get { return _desc; } }
        ...
        // -----------------------------------------------------------------------------------------
        public bool FindTerrainPointUnderMouse(Camera cam, ref Vector3 where)
        // -----------------------------------------------------------------------------------------
        {
